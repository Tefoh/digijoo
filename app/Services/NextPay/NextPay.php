...
use SoapClient;
use App\Services\NextPay\GatewayInterface;
use App\Services\NextPay\GatewayAbstract;
use App\Services\NextPay\NextPayException;
use App\Services\NextPay\ConstGateway;
...
class NextPay extends GatewayAbstract implements GatewayInterface
{
    ...
    {
        $trust = true;
        $this->callback_uri = config('payment.callback_uri','None');
        $this->api_key = config('payment.nextpay_api','None');
